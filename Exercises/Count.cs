...
namespace Exercises
{
    public static class Count
    {
        ...
        {
            //var evenNumbers = numbers.Count(number => number % 2 == 0);
            //var oddNumbers = numbers.Count(number => number % 2 == 1);
            //return evenNumbers > oddNumbers ? true : false;
        ...
        {
            return numberSequences.Any(numbers => numbers.Count() > maxLength);
        }
